use crate::{
    app::{
        ...
        pages::{
            AddFixtureIncrementAxis, AddFixtureKind, AnimationEditState, AnimationUI,
            FixturePerfUi, SceneGraphUI, SystemUI, ViewPerfUI, VisualizerUiState,
        },
    },
    msg::TickSpeeds,
...
pub struct BlaulichtApp {
    ...
    add_fixture_pos_x: f32,
    add_fixture_pos_y: f32,
    ...
    new_fixture_pos_x: f32,
    new_fixture_pos_y: f32,
    new_fixture_pos_z: f32,
...
impl BlaulichtApp {
    fn new_default(
        ...
        Self {
            ...
            add_fixture_pos_x: 0.0,
            add_fixture_pos_y: 0.0,
            ...
            new_fixture_addr: 0,
            new_fixture_uni: 0,
            new_fixture_pos_x: 0.0,
            new_fixture_pos_y: 0.0,
            new_fixture_pos_z: 0.0,
