...
fn render_plugin_ops(
    ...
    while *idx < ops.len() {
        match &ops[*idx] {
            ...
            Op::PainterBegin { id: _, width, height } => {
                *idx += 1;
                ...
                // Consume drawing ops until PainterEnd
                while *idx < ops.len() {
                    match &ops[*idx] {
                        ...
                        Op::PainterText { x, y, size, r, g, b, a, text } => {
                            ...
                            painter.text(
                                ...
                                text,
                                egui::FontId::proportional((*size).max(8) as f32),
                                color,
                            );
                            *idx += 1;
                        }
                        ...
                        Op::PainterCubicBezier { x1, y1, cx1, cy1, cx2, cy2, x2, y2, r, g, b, a, thickness } => {
                            ...
                            let shape = egui::epaint::CubicBezierShape {
                                points: [
                                    rect.min + egui::vec2(*x1 as f32, *y1 as f32),
                                    rect.min + egui::vec2(*cx1 as f32, *cy1 as f32),
                                    rect.min + egui::vec2(*cx2 as f32, *cy2 as f32),
                                    rect.min + egui::vec2(*x2 as f32, *y2 as f32),
                                ],
                                closed: false,
