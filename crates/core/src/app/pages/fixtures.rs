...
use crate::{
    app::{
        components::{self, ButtonColor, ButtonSize, Fader, HFader},
        BlaulichtApp, Selection,
    },
    dmx::{self, EngineGroups, EngineSelection, EngineState, FixtureSelection, FixtureState},
...
//
// impl Pagination {
//     pub fn draw<I, T>(&mut self, ui: &mut egui::Ui, items: I) -> (T, bool)
//     where
...
//         T: Clone,
//     {
//         let number_of_items_total = items.clone().into_iter().count();
...
//
//             ui.horizontal(|ui| {
//                 if button(ui, false, "◀", scene_panel_page_button_sizes) && self.page_index > 0 {
//                     self.page_index -= 1;
//                 }
//
//                 if button(ui, false, "▶", scene_panel_page_button_sizes)
...
//             ui.add_space(5.0);
//
//             ui.label(format!("Page {} / {}", total_pages self.page_index + 1));
